...
class Solver
{
  public:
    ...
    static void VelocityVerlet(CelestialBody<T> &body1, CelestialBody<T> &body2);
...
void Solver<T>::CalculateAcceleration(CelestialBody<T> &body1, CelestialBody<T> &body2)
{
  ...
  */
  ...
  body1.acceleration = (double)-1* F21 / body1.mass;
}
...
template <class T>
void Solver<T>::VelocityVerlet(CelestialBody<T> &body1, CelestialBody<T> &body2)
{
